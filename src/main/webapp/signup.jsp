...
<body>
	...
	<div class="wrap">
		...
		<section>
			<form action="" method="post" name="fr">
				<div class="signup">
					<label>
						아이디 <input type="text" class="id" name="id" required>
					</label>
					...
					<label>
						연락처 <input type="text" class="phone" name="phone" required>
					</label>
	...
	<script type="text/javascript">
		function signupSuccess() {
			...
			if((fr.id.value && fr.pw.value && fr.pwre.value && fr.name.value && fr.nickname.value && fr.email.value && fr.phone.value) != "") {
